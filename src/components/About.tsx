    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8" ref={sectionRef}>
      <div className="text-center mb-12 sm:mb-16 animate-on-scroll">
        ...
        <p className="text-[hsl(var(--muted-foreground))] text-sm sm:text-base">
          Get to know me better with the information down below
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-6xl mx-auto">
        <div className="animate-on-scroll">
          ...
          <p className="text-[hsl(var(--muted-foreground))] mb-4 sm:mb-6 text-sm sm:text-base leading-relaxed">
            My Name is Daniel Poh Ting Fong, I am a Software Engineer with a
            Bachelor&apos;s degree in Software Engineering from Asia Pacific
          ...
          <p className="text-[hsl(var(--muted-foreground))] mb-6 sm:mb-8 text-sm sm:text-base leading-relaxed">
            ...
            passion for emerging technologies, I continuously expand my skills
            through self-directed learning and active participation in various
          ...
          >
            Download Resume <Download className="h-4 w-4 sm:h-5 sm:w-5" />
          </a>
        </div>
        ...
        <div className="animate-on-scroll">
          <div className="grid grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <h4 className="text-2xl sm:text-3xl font-bold text-[hsl(var(--primary))] mb-1 sm:mb-2">
                  {stat.value}
                </h4>
          ...
          <div className="bg-[hsl(var(--card))] p-4 sm:p-6 rounded-lg shadow-md border border-[hsl(var(--border))] hover:border-[hsl(var(--primary))]/50 transition-colors">
            <h4 className="text-lg sm:text-xl font-medium mb-3 sm:mb-4">
              Languages
            </h4>
